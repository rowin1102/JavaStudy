...
public class E01OneDimArray02 {
	...
	public static void main(String[] args) {
		...
		/*
		 	난수 생성 방법1 : Math클래스의 random() 메서드는 0~1사이의
		 	실수를 랜덤하게 반환한다. 정수형태의 난수가 필요하다면 10, 100과 같은
		 	정수를 곱해주면 된다.
		 */
		...
		/*
		 	난수 생성 방법2 : Random클래스를 사용한다. 사용법은 Scanner클래스와 동일하게
		...
		/*
		 	...
		 	2. 45로 %연산하여 나머지를 구한다. 정수를 45로 나누면 나머지는 0~44 사이가 된다.
