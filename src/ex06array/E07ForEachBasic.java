...
/*
 	foreach문(개선된 for문, 확장 for문) : 배열의 일부가 아니라 전체를 참조해야 할때
 		사용하는 for문. 배열의 원소를 참조의 형태로 가져와서 사용.
...
public class E07ForEachBasic {
	...
	public static void main(String[] args) {
		...
		/*
		 	...
		 	더 이상 참조할 원소가 없을 때 for문이 자동으로 종료.
		 */
		sum = 0;
		for(int e : arr) {
		 ...
		 */
		System.out.println("배열 arr의 요소값 1 증가 시키기");
		for(int b : arr) {
