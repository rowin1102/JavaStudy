...
public class E01OneDimArray01 {
	...
	public static void main(String[] args) {
		...
		/*
		 	배열의 선언 및 초기화 : 배열은 여러개의 변수를 사용하기 위해 선언하므로 접근을 위헤
		...
		/*
		 	인스턴스 배열 : 기본자료형을 저장하는 배열이 아닌 인스턴스의 참조값을
		 		자장할 목적으로 생성한 배열을 말한다. 사용법은 동일하다.
		 */
		...
		/*
		 	...
		 	크기를 생략하도록 약속되어 있다.
		 */
		System.out.println("방법2 : 배열의 선언 이후 초기화");
//		int[] initArr2 = new int[3] {1, 20, 300};
		int[] initArray2 = new int[] {1, 20, 300};
		for(int i=0; i<initArray2.length; i++) {
			System.out.println("initArray2 배열 : " + initArray2[i]);
		}
		
		/*
		 	배열을 원소만으로 생성한 후 초기화까지 진행한다. 이 경우 new를
		 	생략할 수 있다.
		 */
		System.out.println("방법3 : 배열의 선언 이후 초기화");
		...
		System.out.println("배열요소의 합 = " + arrSum);
