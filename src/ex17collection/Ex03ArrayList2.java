...
public class Ex03ArrayList2 {
	...
	public static void main(String[] args) {
		...
		/*
		 	아래 2개의 컬렉션은 내부적인 자료구조만 다를뿐 구현방법에는 차이가 없다.
		 	인스턴스 생성시 Student형의 타입매개변수를 통해 생성한다.
		 	Student를 저장할 수 있는 상자가 된다.
		*/
		LinkedList<Student> list2 = new LinkedList<Student>();
		
		// 저장할 Student 인스턴스 생성. 외부패키지에 선언되었으므로 import 후 사용할 수 있다.
		Student str1 = new Student("정우성", 10, "2018");
		Student str2 = new Student("원빈", 20, "2017");
		Student str3 = new Student("장돈건", 30, "2016");
		Student str4 = new Student("공유", 40, "2015");
		...
		*/
		...
		/*
		 	...
		 	즉, 동시에 삭제되지 않는다.
		*/
		boolean removeOk = list2.remove(str2); // 원빈삭제
		// 정상적으로 삭제가 되었다면 true를 반환한다.
		...
		*/
		...
		for(Student st : list2) {
			/*
			 	...
			 	getter를 통해 접근해야 한다. 삭제를 위해 입력한 이름과 Student인스턴스에 저장된
			 	name과 일치하는지 확인한 후 해당 인스턴스를 검색할 수 있다.
			*/
