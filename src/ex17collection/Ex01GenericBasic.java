...
public class Ex01GenericBasic {
	...
	public static void main(String[] args) {
		...
		orange1.showInfo();
		/*
		 	아래와 같이 Orange가 아닌 인스턴스를 저장하면 즉시 컴파일에러가 발생하여 
		 	실행할 수 없는 코드가 된다. 즉, 자료형에는 안전하다고 볼 수 있다.
		*/
//		oBox1.store("당도가 20인 오렌지");
		...
		*/
		...
		/*
		 	하지만 오렌지 같은 String을 저장하고, 이를 꺼내서 다운캐스팅하는 과정에서
		 	예외가 발생된다. 즉, 런타임 에러가 발생하게 되므로
		 	실행전에는 오류를 예측하기 힘든 단점이 있다.
		*/
