...
public class E02StringMethod1 {
	...
	public static void main(String[] args) {
		...
		/*
		 	3] compareTo() : 2개의 문자열의 첫 번째 문자부터 순차적으로 비교하면서
		 		앞 문자의 아스키코드가 크면 양수를 반환하고, 뒷 문자의 아스키코드가 크면
		 		음수를 반환한다. 두 문자열이 같을 때 0을 반환한다.
		 */
		...
		/*
		 	4] concat() : 두 개의 문자열을 연결할 때 사용. print문에서 +와
		 		동일한 역할을 한다.
		 */
		...
		/*
		 	5] contains() : 문자열에 특정 문자열이 포함된 경우 true를 반환
		 */
