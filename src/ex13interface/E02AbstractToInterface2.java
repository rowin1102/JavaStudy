...
/*
 	추상클래스를 인터페이스로 변경하기 : abstract clss => interface
...
// VO(Value Object) : 값만 저장할 수 있는 객체라는 뜻으로 데이터 저장용 클래스가 필요할때 사용한다.
...
/*
 	...
 	클래스가 인터페이스를 상소할때 -> implements
 	메우 드물지만 인터페이스가 인터페이스를 상속할때 -> extends
