...
/*
 	...
 	- 추상클래스와 동일하게 상속을 목적으로 제작되므로 구현받은 하위클래스에서는 반드시
 		추상메서드를 오버라이딩 해야한다.
...
//	public MyInterface1() {}
	...
	*/
	...
	// 멤버메서드 : 메서드는 선언시 추상메서드가 된다. 따라서 public abstract는 생락하는 것이 좋다.
...
class MyClass extends SimpleClass implements MyInterface1, MyInterface2 {
	...
	*/
	...
	// SimpleClass 클래스의 멤버메서드는 오버라이딩이 필수가 아니므로 필요한 경우에만 추가하면 된다.
}
...
public class E03InterfaceMain {
	...
	public static void main(String[] args) {
		...
		// '구현'한 인터페이스를 통해 참조변수를 선언할 수 있다. MyClass의 부모는 모두 3개이다.
