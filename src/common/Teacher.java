...
public class Teacher extends Person {
	...
	/*
	 	hashCode() : 인스턴스가 가진 고유한 주소값을 정수형으로 반환해준다.
	 		따라서 서로 다른 인스턴스라면 다른값을 반환하게 된다.
	 		정수형 멤벼변수는 별도의 처리없이 사용하면 되고, 인스턴스형 멤버변수는
	...
	*/
	...
	public boolean equals(Object obj) {
		...
		/*
		 	age는 int형이므로 비교연산자를 통해 비교한다. subject는 String이므로
		 	equals()를 통해 비교해야 한다. 즉, 우리가 정한 기준에 따라 멤버변수끼리 값이 동일한지
		 	비교하도록 오버라이딩 하면 된다.
		*/
