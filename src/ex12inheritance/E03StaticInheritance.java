...
/*
 	static(정적) 형식의 멤버도 상속이 되고, 하위클래스에서 접근시
 		...
 		단, 클래스 외부에서 접근할때는 인스턴스 생성없이 클래스명을 통해 접근할 수 있다.
...
class Adder {
	...
	/*
	 	...
	 	코드레벨에서 보면 해당 클래스의 멤버변수이므로 변수명만으로 접근하는 것도 가능하다.
...
/*
 	...
 	따라서 자식 클래스에 작성된 모든 코드는 문제없이 실행이 된다.
*/
...
public class E03StaticInheritance {
	...
	public static void main(String[] args) {
		...
		/*
		 	앞에서 호출한 메서드는 모두 메서드영역에 생성된 정적변수 val에 더해지게
		 	되므로 출력결과는 20이 된다.
		*/
		ad.add(1);
