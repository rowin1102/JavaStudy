...
public class E01WrapperClass2 {
	...
	public static void main(String[] args) {
		...
		*/
		...
		// 문자열을 숫자로 변경시 반드시 숫자형식만 기술해야 한다. '원'은 숫자가 아니므로 변경시 예외가 발생한다.
		String money = "120원";
//		System.out.println("120원:" + Integer.parseInt(money)); // 예외발생
		
		// 실수형태의 문자열을 숫자로 변경할때는 parseInt()는 사용할 수 없다. 앞과 동일한 예외가 발생된다.
...
//		System.out.println(Integer.parseInt(floatString));
		...
		// codePointAt() : 문자열에서 특정 index에 해당하는 한 문자의 아스키코드를 반환한다.
		...
		// isLetter() : 문자인지 여부를 판단하는 메서드로 특수기호나 숫자형일때는 fasle를 반환한다.
		...
		/* 
			...
			isUpperCase() : 대문자인지 판단. 단, 영문이 아닌 경우 false를 반환
		*/
