...
public class E04StringType {
	...
	public static void main(String[] args) {
		...
		/*
		 	String 클래스 : 참조형 변수로써 기본자료형이 아닌 클래스로 문자열을 저장하고, 조작하는 기능을 가지고 있다. 
		 		Java에서는 문자열을 표현할 떄 "으로 감싸주면 되고 연결시에는 + 기호를 사용한다.
		 */
		int number = 99;
		
		/*
		 	클래스를 통해 생성한 참조형 변수와 기본 자료형 변수 사이에서는 형변환이 불가능하다. 서로 사용하는 메모리 공간이 다르기 때문
		 	-기본자료형 : Stack(스택) 영역을 사용
		 	-클래스(참조형)변수 : Heap(힙) 영역을 사용
		 */
		// 아래 2개의 문장은 모두 에러가 발생
...
//		String stringNumber2 = (String)100;
		...
		// String은 클래스이므로 new를 사용해서 변수를 생성
		...
		/*
		 	문자열 + 정수 : 우선순위가 없다면 문자열과 숫자가 연결된 상태로 출력된다. 단 산술연산의 결과를 출력하고 싶다면 아래와 같이 소괄호로 묶어서
		 		우선순위에 대한 변화를 주면 된다.
		 */
