...
public class E04OverrideApply {
	...
	public static void main(String[] args) {
		...
		System.out.println("Chid형 참조변수로 Child객체 참조");
		// 자식 인스턴스를 자식 참조변수를 통해 본인 인스턴스를 참조한다.
		DeChild child = new DeChild("율곡이이", 49, "00학번");
		/*
		 	오버라이딩 처리된 메서드이므로 참조변수와 상관없이 항상 자식쪽 메서드가 호출된다.
		 	메서드 오버라이딩은 자식쪽에 정의한 메서드가 부모쪽에 정의된 메서드를 가리게 된다.
